...
final class StreetsRightView: UIView {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            imageView.trailingAnchor.constraint(equalTo: labelContainer.leadingAnchor, constant: -Constants.padding),
...
extension StreetsRightView: PropertyConfigurable {
